...
def test_load_pipeline_from_yaml():
    ...
    # Check that the first node is our FloatValueDataSourceWithDefault
    assert node_configurations[0]["processor"] == "FloatValueDataSourceWithDefault"
    ...
    # Starting value from FloatValueDataSourceWithDefault: 42.0
