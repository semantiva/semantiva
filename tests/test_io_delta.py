...
def test_context_delta_created_and_updated(tmp_path: Path) -> None:
    ...
    tracer = JsonlTraceDriver(str(trace_path), detail="hash")  # hash summaries only
